...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Query para atualizar o campo do profissional
    $sql = "UPDATE profissionais SET $campo = ? WHERE id = ?";
    ...
    if ($stmt->execute()) {
        echo "Os dados do profissional foram atualizados com sucesso.";
    } else {
        echo "Erro ao atualizar os dados do profissional: " . $stmt->error;
    }
